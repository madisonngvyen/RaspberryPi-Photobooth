...
## Hardware Components (Everything is from Amazon, besides the Button to Spade Wire)
- 1x Embedded USB Thermal Printer ($46)
...
- 1x Male T Plug to 2-pin JST-PH2.0 Male Adapter Conversion Cable 22AWG 10cm $9 (This wire is to connect the printer and the battery)
